...
class Storescrren extends StatefulWidget {
  late String selectedDrawerItem = "Store";

  @override
  State<Storescrren> createState() => _TransactionContentState();
}

class _TransactionContentState extends State<Storescrren> {
  late String selectedDrawerItem = "Store";
